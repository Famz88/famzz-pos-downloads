...
Version 1.0.4 has passed the Windows build, 38 regression tests and both npm dependency audits with zero known vulnerabilities. It is an unsigned preview. Read the [v1.0.4 notes and limitations](RELEASE-1.0.4.md). Check Releases for published assets; if v1.0.4 is absent, the maintainer must complete [publishing](RELEASING.md). Earlier releases do not include these fixes.
