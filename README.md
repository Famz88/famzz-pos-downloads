...
The installer targets 64-bit Windows 10/11 and includes the runtime. End users do not need Node.js, a browser server or ChatGPT. Version 1.0.2 uses generic demo company and menu names. A new installation starts with sample menu items and no transaction history; configure them for your business before use.
